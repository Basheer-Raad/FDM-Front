...
const isSmallSidebar = computed(() => layoutStore.sideBarSize === SIDEBAR_SIZE.SMALL);

const isDefaultSideBar = computed(() => layoutStore.sideBarSize === SIDEBAR_SIZE.DEFAULT);
  ...
  >
    <router-link
      ...
      :class="{
        ...
        'group-data-[layout=horizontal]:md:px-5': isNested && !menuItemData.icon,
        '[&.active]:bg-vertical-menu-item-bg-active group-data-[sidebar=dark]:[&.active]:bg-vertical-menu-item-bg-active-dark group-data-[sidebar=brand]:[&.active]:bg-vertical-menu-item-bg-active-brand group-data-[sidebar=modern]:[&.active]:bg-vertical-menu-item-bg-active-modern group-data-[sidebar-size=sm]:group-data-[sidebar=modern]:group-hover/sm:bg-vertical-menu-border-modern': !isNested,
        ...
        'my-1 mx-3': !isNested,
        'ltr:pl-6 rtl:pr-6': isNested && menuItemData.subMenu.length && isDefaultSideBar,
        'ltr:mr-3 rtl:ml-3': isNested,
        'group-data-[sidebar-size=sm]:group-hover/sm:w-[calc(theme(spacing.vertical-menu-sm)_*_3.62)]': !isNested, // title of submenu on hover / click,
        'group-data-[sidebar-size=sm]:[&.dropdown-button]:after:hidden group-data-[layout=horizontal]:[&.dropdown-button]:before:rotate-90': !isNested,
        'ml-0': isNested && isDefaultSideBar,
        'group-data-[sidebar-size=sm]:group-data-[sidebar=dark]:group-hover/sm:!bg-transparent group-data-[sidebar=modern]:group-data-[sidebar-size=sm]:group-hover/sm:bg-transparent group-data-[layout=horizontal]:[&.dropdown-button]:before:rotate-270': isNested,
      }"
    ...
    >
      ...
      <span
        ...
        :class="{
          'group-data-[sidebar-size=sm]:ltr:pl-10 group-data-[sidebar-size=sm]:rtl:pr-10': !isNested,
        }"
    ...
    <div
      ...
      :class="{
        ...
        show: isDrawerActive || menuItemData.isActive,
        'group-data-[layout=horizontal]:ltr:md:left-full group-data-[layout=horizontal]:rtl:md:right-full group-data-[layout=horizontal]:md:absolute group-data-[sidebar-size=sm]:rounded-tr-md group-data-[sidebar-size=sm]:top-0': isNested,
        'group-data-[layout=horizontal]:md:fixed': !isNested,
        'group-data-[sidebar-size=sm]:hidden group-data-[sidebar-size=sm]:group-hover/sm:block group-data-[sidebar-size=sm]:top-auto': !isNested, // disable hover effect on nested submenu,
      }"
    >
      <ul
        ...
        :class="{
          'group-data-[layout=horizontal]:max-h-80 group-data-[layout=horizontal]:overflow-y-auto': isNested,
        }"
      >
